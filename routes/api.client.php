...
Route::group([
    ...
    $router->post('addresses/{id}/makeDefault', 'Addresses\AddressController@makeDefault');
    $router->post('addresses/{id}/removeDefault', 'Addresses\AddressController@removeDefault');
    /*
        |--------------------------------------------------------------------------
        | API Client Routes
        |--------------------------------------------------------------------------
